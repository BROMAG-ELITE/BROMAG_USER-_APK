...
class TakeawaySubCatAdapter(private val items: java.util.ArrayList<SubCusineGridList?>, updateList: TakeawayMenuListActivity) : RecyclerView.Adapter<TakeawaySubCatAdapter.StaticViewHolder>() {
    var rowindex = -1
