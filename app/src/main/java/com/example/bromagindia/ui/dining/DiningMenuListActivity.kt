...
class DiningMenuListActivity : AppCompatActivity(), UpdateList {

    private var categoryRecyclerView: RecyclerView? = null
    private  var subcategoryRecyclerView: RecyclerView? = null
    private var categoryAdapter: DiningSubCatAdapter? = null
    private var subcategoryAdapter: DiningMenuListAdapter? = null

    var items: java.util.ArrayList<MenuList> = java.util.ArrayList<MenuList>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_dining_menu_list)
        ...
        categoryAdapter = DiningSubCatAdapter(item, this)
        categoryRecyclerView?.adapter = categoryAdapter

        items = ArrayList()
        subcategoryAdapter = DiningMenuListAdapter(items)
