...
class SubCatAdapter(private val items: java.util.ArrayList<SubCusineGridList?>, updateList: MenuListActivity) : RecyclerView.Adapter<SubCatAdapter.StaticViewHolder>() {
    var rowindex = -1
